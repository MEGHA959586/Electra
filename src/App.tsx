...
const AppContent = () => {
    ...
    return (
        ...
        `}</style>
            ...
            {/* ========== MARQUEE – RIGHT BELOW HEADER (GLOBAL) ========== */}
            <div className="overflow-hidden whitespace-nowrap bg-amber-50/70 border-y border-amber-200/50 py-1 text-[10px] font-medium text-stone-700">
                                            ...
                                            <div className="flex justify-center gap-2 mt-6">
                                                {slides.map((_, idx) => (
                                                    <button
                                                        ...
                                                        className={`h-2 w-2 rounded-full transition-all ${currentSlide === idx ? "bg-amber-600 w-6" : "bg-stone-300"
                                                            }`}
